...
public final class MyMenu extends VBox {
    ...
    public MyMenu(final SimpleObjectProperty<?> trainerProperty,
        ...
        toolBar.getItems().addAll(newBtn, openBtn, saveBtn, new MySeparator(), trainBtn, continueBtn,
                pauseBtn, stopBtn, new MySeparator(), testBtn, new MySeparator(), predictBtn);
